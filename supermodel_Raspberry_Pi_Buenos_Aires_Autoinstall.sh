...
sudo mv /home/pi/SuperModel3_Pi_Buenos_Aires/supermodel /opt/retropie/emulators/supermodel/bin/
echo "Y ya que estamos el resto, dale?..Si, obvio!"
sudo mv /home/pi/SuperModel3_Pi_Buenos_Aires/Config /opt/retropie/emulators/supermodel/bin
sudo mv /home/pi/SuperModel3_Pi_Buenos_Aires/NVRAM /opt/retropie/emulators/supermodel/bin
sudo mv /home/pi/SuperModel3_Pi_Buenos_Aires/Saves /opt/retropie/emulators/supermodel/bin
sudo mv /home/pi/SuperModel3_Pi_Buenos_Aires/Shaders /opt/retropie/emulators/supermodel/bin
...
sudo mv /home/pi/SuperModel3_Pi_Buenos_Aires/emulators.cfg /opt/retropie/configs/model3/
sudo mv /home/pi/SuperModel3_Pi_Buenos_Aires/retroarch.cfg /opt/retropie/configs/model3/
sudo mv /home/pi/SuperModel3_Pi_Buenos_Aires/joystick-selection.cfg /opt/retropie/configs/model3/
...
cd
mkdir /home/pi/RetroPie/roms/model3
...
echo
sudo mv /home/pi/SuperModel3_Pi_Buenos_Aires/es_systems.cfg /etc/emulationstation/es_systems.cfg
echo "Movemos la carpeta model3 para que nuestro menu tenga un theme propio" 
sudo mv /home/pi/SuperModel3_Pi_Buenos_Aires/model3 /etc/emulationstation/themes/carbon/
echo
...
echo
rm -rf /home/pi/SuperModel3_Pi_Buenos_Aires
echo
sudo reboot
echo "Adeus"
